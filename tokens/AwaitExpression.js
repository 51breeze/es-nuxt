module.exports = function(ctx,stack){
    const AwaitExpression = ctx.plugin.getTokenNode('AwaitExpression', true);
    return AwaitExpression(ctx,stack)
    ...
    //     let isUseAsyncData = false;
    //     if(stack.argument.isCallExpression && stack.argument.callee.value() ==='useAsyncData'){
